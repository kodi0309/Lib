...
<div id="tresc">	
		...
		<table border="1" bordercolor="#FFFFFF" class="dane" cellpadding="5">
			<tr><td> LP. </td>	<td> TYTUŁ </td>	<td> UCZEŃ </td>	<td> DATA </td>		<td> STATUS </td>		<td> EDYTUJ </td>  <td> USUŃ </td> </tr>
				...
				$t=$_POST['tytul'];
				$zapytanie="SELECT wypozyczenia.iduczenw, wypozyczenia.idksiazkaw, wypozyczenia.idwypozyczenie, ksiazki.tytul, uczniowie.uczen, wypozyczenia.data, wypozyczenia.status FROM ksiazki, uczniowie, wypozyczenia WHERE ksiazki.idksiazka=wypozyczenia.idksiazkaw AND uczniowie.iduczen=wypozyczenia.iduczenw AND tytul LIKE '%".$t."%'ORDER BY data DESC";
